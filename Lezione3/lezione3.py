...
string2: str= input("Insert a second string")
if string==string2:
    print("strings are the same")
else: 
    print("strings are not the same")
if string.lower()==string2:
    print("strings are not the same") 
else: 
    print("strings are the same")
...
alien_color: str= "green"
if alien_color == 'green':
    print("the alien’s color is green, you just earned 5 points for shooting the alien")
else:
    print("the alien’s color isn’t green, you just earned 10 points")
alien_color: str= "red"
if alien_color == 'green':
    print("the alien’s color is green, you just earned 5 points for shooting the alien")
else:
...
favorite_fruit: list = ["apple","banana","pear"]
for a in favorite_fruit:
    if a == 'apple':
        print("you like apple")
    elif a == 'kiwi':
        print("you dont like kiwi")
    elif a == 'banana':
...
usernames: list = ["luigi","admin","mario"]
for a in usernames:
    if a == 'luigi':
        print("Hi luigi")
    elif a == 'admin':
...
current_users:list=["mario","luigi","luca","giorgio","flavio"]
new_users:list=["carlo","mario","andrea","luca"]
for a in new_users:
    ...
    if not is_not_avaliable:
        print(f"the username {a} is available")
